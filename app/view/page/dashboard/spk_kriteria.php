                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="number" class="form-control" name="bobot_kriteria" step="any" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 mb-3">
                                            <label class="form-label">Bobot Kriteria</label>
                                            <input type="number" class="form-control" name="bobot_kriteria" value="<?= $data['bobot_kriteria'] ?>" step="any" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
